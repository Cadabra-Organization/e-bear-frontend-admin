...
export default function DataTableTable({ pageInfo, headCells, rows, searchConfig, labelConfig, writeFunc, deleteFunc, detailFunc, handleSearch, couponFunc }) {
