        ...
        stage('Deploy Prepare Check Running Container'){
            steps{
                 script {
                    ...
                    def containerName = 'ecommerce-fe-admin'
        ...
        stage('Deploy Prepare Check Image') {
            steps {
                script {
                    ...
                    def imageName = 'ecommerce-fe-admin-image'
                    def imageId
        ...
        stage('Deploy Prepare Make Image') {
            steps {
                script {
                    ...
                    def dockerfileDir = 'ecommerce-admin'
            ...
            steps {
                script {
                   // 컨테이너의 이름
                    ...
                    sh "docker run -d -e TZ=Asia/Seoul -p 4000:4000 --name ${containerName} ${imageFullName}"
